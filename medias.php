                                ...
                                <div class="span9">
                                      ...
                                      <?php 
                                           if(isset($_GET['type'])){
                                                      ...
                                                      echo'<div class="heading2 span12">
                                                                <h2><span>Médiathèque : '. $_GET['type'].'</span></h2>
                                                          </div>
                                                          ';
                                                  }
                                       ?>
                                           ...
                                           <?php require_once('include/page/more-article.php'); /**/?>
                                              <!-- contenu -->
                                               <?php
                                                  ...
                                                  if(isset($_GET['type'])){
                                                      $list=$ListCatEvent->CatMedia($_GET['type'],10,"DESC");
                                                  }
                                                  ...
                                                  for($i=0;$i<sizeof($list);$i++){
                                                    ...
                                                    echo'
                                                             ...
                                                             <div class="img" style="background: url(myadmin/'.$list[$i]['vignette'].') center;">&nbsp;</div>
                                                                    <h4 class="titre_event"> <a href="media-'.$_GET['type'].'-full.php?id='.$list[$i]['idMedia'].'">'.$list[$i]['titreMedia'].'</a></h4>
                                                                    <div class="cat_event"> > '.$list[$i]['nomCategorie'].'</div>
