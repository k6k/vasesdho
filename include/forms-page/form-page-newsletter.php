	...
	<body>
		 ...
		 $testChamp = new GeneralsQueries;
		  ...
		  if(isset($_GET['id'])){
			  ...
			  $action="inserer";}
				 ...
				 $testChamp->valeurs="item = 'newsletter' AND utilisateur_id_user = '".$_SESSION['appUserId']."' ";
	 ...
	 <div class="page-header">
						 		<h4 class="Heading4">Formulaire newsletter!</h4>
						 	</div>

	<form class="formulaire"  method="POST" action="../recup/recup-newsletter.php" class="form-horizontal">
			...
			<div class="controls">
			 ...
			 $("#button").on("click",function(){
				 ...
				 $.ajax({
					 ...
					 url: "../recup/recup-newsletter.php",
