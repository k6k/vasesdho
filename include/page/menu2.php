		                                        		...
		                                        		?>
		                                        			<li class="simple">
                                                                ...
                                                                echo $resArt[$i]['link'].'&id='.$resArt[$i]['idMenu'];
                                                                 ...
                                                                 ?>"><?php echo ucfirst($resArt[$i]['Menu']); ?></a>
                                                              </li>
                                                             <?php 
                                                             	if($a==sizeof($resArt))  {
														 ...
														 ?>
														 			 <li class="dropdown"><a href="<?php echo $resArt[$i]['link']; ?>" class="dropdown-toggle" role="button" data-toggle="dropdown" > <?php echo $resArt[$i]['Menu']; ?> <b class="caret"></b></a>
														 			 	<ul class="dropdown-menu" id="sub-menu">
														 			 		...
														 			 		?>
														 			 				<li><a href="<?php echo $resSubMenu[$j]['menulink']; ?>"><?php echo ucfirst($resSubMenu[$j]['subMenu']); ?></a></li>
