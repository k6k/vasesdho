...
(function($){
	...
	$.fn.contactable = function(options) {
		//set default options  
		var defaults = {
			url: 'include/function/mail.php',
			name: 'Nom',
			email: 'Email',
			message : 'Message',
			subject : 'SOS Pasteur',
			submit : 'Envoyer',
			recievedMsg : 'Votre message a été bien envoyé !',
			notRecievedMsg : 'Désolé votre message n\'a pas été transmis , veuillez reéssayer',
			disclaimer: 'Ce message est privé et ne sera lu uniquement que par le Pasteur',
			hideOnSubmit: false
