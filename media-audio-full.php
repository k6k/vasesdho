    ...
    <!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
        ...
        <!----><link href='http://fonts.googleapis.com/css?family=Philosopher' rel='stylesheet' type='text/css'>      
            ...
            <!---->   <script type="text/javascript">jwplayer.key="Xe2gcXXSeH4CRyhdPVW6sLeMwl4+XOFvTsSv3A==";</script>
                                              ...
                                              <!-- contenu -->
                                               <?php
                                                    ...
                                                    if(isset($_GET['id'])){
                                                         ...
                                                         $list=$ListCatEvent->SelectMedia($_GET['id'],6,"DESC");
                                                         /*var_dump($list);*/


                                                         $rep= $list[0]['chemin'];
                                                         /*echo $rep;*/
                                                         $media=glob(''.$rep.'/*.{mp3}', GLOB_BRACE);
                                                       
                                                         

                                                            echo "<div id='test' style='position: relative;'></div>";
