	 ...
	 <div class="page-header">
						 		<h4 class="Heading4" style="display:inline-block;">Visualisation de la table : categories  </h4>
						 		<div style="margin-left:200px;display:inline-block;"><a href="formulaire.php?form=categories" class="btn btn-danger">Ajouter un nouvel enregistrement</a></div>
						 	</div>	 <?php
	 ...
	 $donnees=array('nomSection-Section parente','nomCategorie-nom de la Categorie','categorieterms-termship','description-description','edit-edition','delete-suppression');
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "formulaire.php?form=categories&id=".$res[$i][0].""; ?>" class="fancybox fancybox.iframe btn" title="Modifier"><i class="icon-pencil"></i></a></td>
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "?form=categories&id=".$res[$i][0].""; ?>" class="dialog btn" title="Supprimer" ><i class="icon-trash"></i></a></td>
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "include/forms-page/form-page-categories.php?id=".$res[$i][0].""; ?>" class="action"  class="fancybox fancybox.iframe btn" ><i class="icon-share-alt"></i></a></td>
