	 ...
	 <div class="page-header">
						 		<h4 class="Heading4" style="display:inline-block;">Visualisation de la table : sousmenu  </h4>
						 		<div style="margin-left:200px;display:inline-block;"><a href="formulaire.php?form=sousmenu" class="btn btn-danger">Ajouter un nouvel enregistrement</a></div>
						 	</div>	 <?php
	 ...
	 $donnees=array('idSousMenu-#','textMenu-Menu parent','subMenu-Sous Menu','menulink-liens','edit-edition','delete-suppression');
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "include/forms-page/form-page-sousmenu.php?id=".$res[$i][0].""; ?>" class="fancybox fancybox.iframe btn" title="Modifier"><i class="icon-pencil"></i></a></td>
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "?form=sousmenu&id=".$res[$i][0].""; ?>" class="dialog btn" title="Supprimer" ><i class="icon-trash"></i></a></td>
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "include/forms-page/form-page-sousmenu.php?id=".$res[$i][0].""; ?>" class="action"  class="fancybox fancybox.iframe btn" ><i class="icon-share-alt"></i></a></td>
