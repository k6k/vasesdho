	 ...
	 <div class="page-header">
						 		<h4 class="Heading4" style="display:inline-block;">Visualisation de la table : articles  </h4>
						 		<div style="margin-left:200px;display:inline-block;"><a href="formulaire.php?form=articles" class="btn btn-danger">Ajouter un nouvel enregistrement</a></div>
						 	</div>	 <?php
...
/*'contenuArticle-contenu',*/
	 $donnees=array('idArticle-#','nomCategorie-Categorie','titreArticle-titre','dateArticle-date','statut-statut','langues-langue','edit-edition','delete-suppr');
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "formulaire.php?form=articles&id=".$res[$i][0].""; ?>" class="btn" title="Modifier"><i class="icon-pencil"></i></a></td>
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "?form=articles&id=".$res[$i][0].""; ?>" class="dialog btn" title="Supprimer" ><i class="icon-trash"></i></a></td>
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "include/forms/form-articles.php?id=".$res[$i][0].""; ?>" class="action"  class="fancybox fancybox.iframe btn" ><i class="icon-share-alt"></i></a></td>
