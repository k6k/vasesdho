	 ...
	 <div class="page-header">
						 		<h4 class="Heading4" style="display:inline-block;">Visualisation de la table : media  </h4>
						 		<div style="margin-left:200px;display:inline-block;"><a href="formulaire.php?form=medias" class="btn btn-danger">Ajouter un nouvel enregistrement</a></div>
						 	</div>	 <?php
	 ...
	 $donnees=array('nomCategorie-Categorie','nomMedia-Type','titreMedia-titre','chemin-repertoire','autheur-autheur','dateCreation-date de Creation','edit-edition','delete-Suppression');
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "formulaire.php?form=medias&id=".$res[$i][0].""; ?>" class="btn" title="Modifier"><i class="icon-pencil"></i></a></td>
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "?form=medias&id=".$res[$i][0].""; ?>" class="dialog btn" title="Supprimer" ><i class="icon-trash"></i></a></td>
	 ...
	 ?>
				 ...
				 <td style="text-align:center;"><a href="<?php echo "formulaire.php?form=medias&id=".$res[$i][0].""; ?>" class="action"  class="btn" ><i class="icon-share-alt"></i></a></td>
