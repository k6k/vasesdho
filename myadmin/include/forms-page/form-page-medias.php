	...
	<body>
	 ...
	 <?php
		 ...
		 if(isset($_GET['id'])){
			 ...
			 $typeMedia_idTypeMedia = html_entity_decode($res[0]['typeMedia_idTypeMedia']);

			 $thematique= html_entity_decode($res[0]['thematique']);

			 $titreMedia= html_entity_decode($res[0]['titreMedia']);

			 $description= html_entity_decode($res[0]['description']);

			 $autheur= html_entity_decode($res[0]['autheur']);

			 $duree= html_entity_decode($res[0]['duree']);

			 $chemin= html_entity_decode($res[0]['chemin']);
	...
	<form class="formulaire"  method="POST" action="../recup/recup-medias.php" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<select name='typeMedia_idTypeMedia' id='typeMedia_idTypeMedia' value='<?php echo $typeMedia_idTypeMedia;?>' required><option value="">Selectionnez une option</option>
							...
							<?php include("../loader/load-typemedia.php");
		...
		<div class="control-group">
			...
			<label class="control-label" for="chemin">Chemin</label>

			<div class="controls">

				<input type='text' name='chemin' id='chemin' value='<?php echo $chemin;?>' required class="special"/>
			 ...
			 $("#button").on("click",function(){
				 ...
				 $.ajax({
					 ...
					 url: "../recup/recup-medias.php",

					 data : {' typeMedia_idTypeMedia': typeMedia_idTypeMedia,' thematique': thematique,' titreMedia': titreMedia,' description': description,' autheur': autheur,' duree': duree,' chemin': chemin,'operation':id},
